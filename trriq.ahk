...
/*	Input a file, process either HL7 ORU or PDF
	Contains all necessary functions for extracting result to common form
 */
	__New(fileIn) {
...
*/
	if (fldval.monType~="PR|HOL|Zio|Mini|BGM") {
		tabs := ["dem-Name_L","dem-Name_F","dem-Name_M","dem-MRN","dem-DOB","dem-Sex(NA)"
				...
				,"ve-Triplets(0)","ve-Couplets(0)","ve-SinglePVC(0)","ve-InterpPVC(0)","ve-R_on_T(0)"
				,"ve-SingleVE(0)","ve-LateVE(0)","ve-Bigem(0)","ve-Trigem(0)","ve-SVE(0)"
...
*/
	...
	*/
	...
	FileMove(path.PrevHL7in fldval.file.fileNam ".hl7", ".\tempfiles\" fldval.file.fileNam ".hl7",1)
